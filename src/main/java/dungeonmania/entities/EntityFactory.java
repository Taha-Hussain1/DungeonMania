...
public class EntityFactory {
    ...
    public SnakeHead buildSnake(Position pos) {
        ...
        double snakeHbuff = config.optDouble("snake_health_treasure_buff", SnakeHead.SNAKE_HEALTH_TREASURE_BUFF);
        double snakeHmult = config.optDouble("snake_health_key_buff", SnakeHead.SNAKE_HEALTH_KEY_BUFF);
        double snakeAbuff = config.optDouble("snake_attack_arrow_buff", SnakeHead.SNAKE_ATTACK_ARROW_BUFF);
        return new SnakeHead(pos, snakeHealth, snakeAttack, snakeHbuff, snakeHmult, snakeAbuff);
    }

    public void addBody(Game game, Position pos, SnakeBody segment, double snakeHbuff, double snakeHmult,
            double snakeAbuff) {
        GameMap map = game.getMap();
        map.addEntity(segment);
    }
