...
public class BombTest {
    ...
    @Test
    @Tag("8-9")
    @DisplayName("Testing functionality of OR & AND Logic rule for logic bomb")
    public void logicBombOrAndTest() {
        DungeonManiaController dmc;
        dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_bombTest_OrAndLogic", "simple");

        assertEquals(2, TestUtils.getEntities(res, "bomb").size());


        // explode or & and bombs
        res = dmc.tick(Direction.RIGHT);
        assertEquals(0, TestUtils.getEntities(res, "bomb").size());
    }
    ...
    @Test
    @Tag("8-10")
    @DisplayName("Testing functionality of COAND Logic rule for logic bomb")
    public void logicBombCoAndTest() {
        DungeonManiaController dmc;
        dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_bombTest_CoAndLogic", "simple");

        assertEquals(1, TestUtils.getEntities(res, "bomb").size());
        assertEquals(1, TestUtils.countType(res, "bomb"));
    ...
    @Test
    @Tag("8-11")
    @DisplayName("Testing functionality of XOR Logic rule for logic bomb")
    public void logicBombXorTest() {
        DungeonManiaController dmc;
        dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_bombTest_XorLogic", "simple");
    ...
    @Test
    @Tag("8-12")
    @DisplayName("Testing functionality of bomb being overlapped by a boulder")
    public void bombOverlapTest() {
        DungeonManiaController dmc;
        dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_bombTest_BombOverlap", "simple");

        // push boulder onto bomb
        res = dmc.tick(Direction.RIGHT);
        assertEquals(1, TestUtils.getEntities(res, "bomb").size());
        // push boulder off bomb and pick up bomb
        res = dmc.tick(Direction.RIGHT);
        assertEquals(0, TestUtils.getEntities(res, "bomb").size());
    }
}
